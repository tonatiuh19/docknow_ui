        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 pl-10 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-ocean-500 focus:border-ocean-500"
            ...
            <div>
              ...
              >
                {loading ? <div className="spinner"></div> : t("auth.signIn")}
              </button>
            </div>
          </form>
